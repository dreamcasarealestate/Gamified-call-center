            ...
            {validating ? (
              ...
              >
                ...
                <motion.button
                  ...
                  type="submit"
                  disabled={submitting}
                  className="w-full py-3 sm:py-4 px-6 rounded-lg sm:rounded-xl  font-bold text-white flex items-center justify-center gap-2 sm:gap-3 transition-all shadow-lg hover:shadow-xl text-sm sm:text-base"
                  style={{
                    background: `linear-gradient(135deg, ${COLORS.primary}, ${COLORS.secondary})`,
