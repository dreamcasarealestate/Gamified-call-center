    ...
    <div className="rounded-[10px] border border-white/10 bg-[#9BB4C0] p-5">
      <div className="flex items-start justify-between gap-3">
        <div>
          ...
          <div className="text-lg  font-bold">{appTitle(app)} • {rangeLabel(range)}</div>
      ...
      <div className="mt-5 grid grid-cols-1 lg:grid-cols-2 gap-4">
        <div className="rounded-xl border border-white/10 bg-white/3 p-4">
          <div className="text-sm  font-bold">Calls / Deals</div>
        ...
        <div className="rounded-xl border border-white/10 bg-white/3 p-4">
          <div className="text-sm  font-bold">XP Velocity</div>
          <div className="mt-3 h-55">
            <ResponsiveContainer width="100%" height="100%">
