    ...
    <div className="rounded-[10px] border border-white/10 bg-[#9BB4C0] p-5 h-full">
      <div className="flex items-start justify-between">
        <div>
          ...
          <div className="text-lg  font-bold">Top Agents</div>
          ...
          <div key={e.id} className="rounded-xl border border-white/10 bg-white/3 px-4 py-3">
            <div className="flex items-center justify-between gap-3">
              <div className="flex items-center gap-3 min-w-0">
                <div className="h-9 w-9 rounded-xl bg-white/10 border border-white/10 flex items-center justify-center text-sm  font-bold">
                  #{e.rank}
                </div>
