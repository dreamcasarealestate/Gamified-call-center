        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <div className="text-lg md:text-xl  font-bold leading-tight">{profile.name}</div>
              <div className="mt-1 flex flex-wrap items-center gap-2 text-xs text-white">
                <span className="rounded-full border border-white/10 bg-white/5 px-2 py-1">
                  Level <span className="text-white/90  font-bold">{profile.level}</span>
                </span>
                <span className="rounded-full border border-white/10 bg-white/5 px-2 py-1">
                  Streak <span className="text-white/90  font-bold">{profile.streakDays}</span> days
                </span>
                <span className="rounded-full border border-white/10 bg-white/5 px-2 py-1">
                  XP <span className="text-white/90  font-bold">{formatCompactNumber(profile.currentXp)}</span> /{" "}
